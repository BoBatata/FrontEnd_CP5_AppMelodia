...
const UserCommentary = ({name, text, photo, alt}) => {
    return (
        <div className="h-fit w-full flex flex-col items-center text-center bg-[var(--secundaria)] rounded-lg p-4 md:p-6 shadow-sm hover:shadow-md transition-shadow mx-auto">
